...
class Blastoise(Water):
    ...
    def __repr__(self):
        return f"The Blastoise {self.get_name()} of level: {self.__level} with {self.__hit_points} HP"
